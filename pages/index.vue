<template>
  <div class="relative">
    <div class="container mx-auto px-6 pt-10 py-10 text-center relative" style="z-index: 1">
      ...
      <div class="max-w-lg mx-auto text-lg font-normal text-gray-700 roboto text-center tracking-wide mt-3 tracking-wider">
